...
public class HomeController {
	...
	@RequestMapping(value = "/getPacientePorIdUsuario", method = RequestMethod.GET, produces = {"application/json"})
	public @ResponseBody<json> String getPacientePorIdUsuario(@RequestParam(value="idUsuario", required=true) int idUsuario) throws JsonProcessingException {
		//ResponseBody<json>: Aclara que el String guarda un JSON
		//ObjectMapper: Es una clase de Jackson que permite convertir una colección a un JSON usando el método writeValueAsString
	...
	@RequestMapping(value = "/getMedicoPorIdUsuario", method = RequestMethod.GET, produces = {"application/json"})
	public @ResponseBody<json> String getMedicoPorIdUsuario(@RequestParam(value="idUsuario", required=true) int idUsuario) throws JsonProcessingException {
		//ResponseBody<json>: Aclara que el String guarda un JSON
		//ObjectMapper: Es una clase de Jackson que permite convertir una colección a un JSON usando el método writeValueAsString
	...
	public ResponseEntity<Void> cambiarEstadoDeTurno( @RequestParam(value="idTurno", required=true) int idTurno, @RequestParam(value="idPaciente", required=false) Integer idPaciente, @RequestParam(value="asistencia", required=false) Integer asistencia, @RequestParam(value="disponibilidad", required=false) Integer disponibilidad, @RequestParam(value="justificacionInasistencia", required=false) String justificacionInasistencia) {
		//ResponseBody<json>: Aclara que el String guarda un JSON
		//ObjectMapper: Es una clase de Jackson que permite convertir una colección a un JSON usando el método writeValueAsString
				
		try {
			
			Controlador.getInstancia().cambiarEstadoDeTurno(idTurno, idPaciente, asistencia, disponibilidad, justificacionInasistencia);
			return new ResponseEntity<Void>(HttpStatus.CREATED);												
		} catch (TurnoException e) {
			return new ResponseEntity<Void>(HttpStatus.CONFLICT);												
	...
	@RequestMapping(value = "/getTurnosDisponiblesMedicoPorDia", method = RequestMethod.GET, produces = {"application/json"})
	public @ResponseBody<json> String getTurnosMedico(@RequestParam(value="matricula", required=true) String matricula, @RequestParam(value="fecha", required=false) String fecha) throws JsonProcessingException {
		//ResponseBody<json>: Aclara que el String guarda un JSON
		//ObjectMapper: Es una clase de Jackson que permite convertir una colección a un JSON usando el método writeValueAsString

			List<TurnoView> turnosMed = null;
			try {
				turnosMed = Controlador.getInstancia().getTurnosDisponiblesMedicoPorDia(matricula, new SimpleDateFormat("MM/dd/yyyy").parse(fecha)); //capaz cambia la fecha
			} catch (ParseException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
	...
	public @ResponseBody<json> String getTurnosEspecialidadPorDia(@RequestParam(value="idEspecialidad", required=true) int idEspecialidad, @RequestParam(value="fecha", required=true) String fecha) throws JsonProcessingException {
		...
		//ObjectMapper: Es una clase de Jackson que permite convertir una colección a un JSON usando el método writeValueAsString
			...
			System.out.println("Adem�s, ac� en el home tambi�n tenemos disponible para usted el idEspecialidad, que es: " + idEspecialidad);
	...
	public @ResponseBody<json> String getCantidadTurnosDisponiblesPorDiaDeUnaEspecialidad(@RequestParam(value="idEspecialidad", required=true) int idEspecialidad, @RequestParam(value="matriculaMedPac", required=false) String matriculaMedPac) throws JsonProcessingException {
		//ResponseBody<json>: Aclara que el String guarda un JSON
		//ObjectMapper: Es una clase de Jackson que permite convertir una colección a un JSON usando el método writeValueAsString

			TreeMap<Date,Integer> turnosDisponibles = Controlador.getInstancia().getCantidadTurnosDisponiblesPorDiaDeUnaEspecialidad(idEspecialidad, matriculaMedPac);
			ObjectMapper mapper = new ObjectMapper();
	...
	public @ResponseBody<json> String getCantidadTurnosDisponiblesPorDiaDeUnaEspecialidadYMedico(@RequestParam(value="idEspecialidad", required=true) int idEspecialidad, @RequestParam(value="matricula", required=true) String matricula) throws JsonProcessingException {
		...
		//ObjectMapper: Es una clase de Jackson que permite convertir una colección a un JSON usando el método writeValueAsString
			...
			TreeMap<Date,Integer> turnosDisponibles = Controlador.getInstancia().getCantidadTurnosDisponiblesPorDiaDeUnaEspecialidadYMedico(idEspecialidad, matricula);
			ObjectMapper mapper = new ObjectMapper();
			return mapper.writeValueAsString(turnosDisponibles);
	}
}
